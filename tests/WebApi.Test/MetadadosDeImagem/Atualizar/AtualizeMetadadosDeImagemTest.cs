...
public class AtualizeMetadadosDeImagemTest : IClassFixture<CustomWebApplicationFactory>
{
	private readonly HttpClient _httpClient;

	public AtualizeMetadadosDeImagemTest(CustomWebApplicationFactory factory)
	{
